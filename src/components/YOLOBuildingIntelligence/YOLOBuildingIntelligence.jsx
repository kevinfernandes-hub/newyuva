        ...
        <div className={styles.metricsGrid}>
          ...
          <div className={styles.metricCard}>
            ...
            <div className={styles.metricVal}>
              {viewMode === 'officer' ? 'STRONG' : `${((summary.top_yolo_confidence || 0.85) * 100).toFixed(1)}%`}
            </div>
          ...
          <div className={styles.metricCard}>
            ...
            <div className={`${styles.metricVal} ${styles.purpleVal}`}>
              {summary.total_change_pixel_area ? `${summary.total_change_pixel_area.toLocaleString()} px` : '3,010 px'}
            </div>
